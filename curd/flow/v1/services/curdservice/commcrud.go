...
// 公共方法
type CommCRUD struct {
}

// 创建CRUD对象
func (c *CommCRUD) Create(dbInst *gorm.DB, obj interface{}) (err error) {
	tx := dbInst.Begin()
...
// no records exist
func (c *CommCRUD) BaseGetAll(dbInst *gorm.DB, crudModel interface{}, ret interface{}, querys []*common.QueryConditon, fields []string, sortby []string, order []string,
...
// 获取一个CRUD对象
func (c *CommCRUD) BaseGetOne(dbInst *gorm.DB, crudModel interface{}, id int64) (ret interface{}, err error) {
...
// 更新一个CRUD 对象
func (c *CommCRUD) BaseUpdate(dbInst *gorm.DB, crudModel interface{}, fields []string, saveNil ...bool) (ret interface{}, err error) {
	var count int64
...
// 基础方法 ---
func (c *CommCRUD) BaseQuery(dbInst *gorm.DB, crudModel interface{}, querys []*common.QueryConditon,
...
// db 数据连接
// model 实例
func (c *CommCRUD) ImportData(data [][]string, head []string, db *gorm.DB,
